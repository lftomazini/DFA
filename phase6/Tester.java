...
public class Tester {
    ...
    public static void main(String[] args) {
        Tester t = new Tester();
        System.out.println(
                "Generating tree with alphabet \"" + ALPHABET + "\" of size " + SIZE + "...");
        ...
        System.out.println("---------------");
        System.out.println(
                "Number of states (Q):                            " + ourdfa.states.size);
        System.out.println(
                "Number of transitions (Q x |Sigma|):             " + ourdfa.transitions.size);
        System.out.println(
                "Steps to create DFA (Q^2 x |Sigma| x 2^(size)): " + (int) (Math.pow(
                                                                            ourdfa.states.size,
                                                                            2) * ourdfa.transitions.size * Math.pow(
                                                                            2,
                                                                            SIZE)));
