...
public class Tester {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Language: ((c CONCAT ab) UNION dac UNION (a STAR UNION b STAR))");
        System.out.println("Generating 100 random strings and checking if they match the above RE...\n");
        ...
        System.out.println("Total number of transitions: " + re.dfa.transitions.size);
        System.out.println("The time it takes to create a DFA is O(|states|^2 * |transitions|)");
    }
